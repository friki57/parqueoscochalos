...
function eventManagerListen(eventManager, listener) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var eventManagerImpl, query, firstListen, queryInfo, _f, e_7, firestoreError, raisedEvent, raisedEvent_1;
        return tslib.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
            ...
            switch (_f.label) {
                case 0:
                    ...
                    return [4 /*yield*/, executeQuery(syncEngineImpl.localStore, queryView.query, 
                        /* usePreviousResults= */ false).then(function (_f) {
...
var FirestoreClient = /** @class */ (function () {
    ...
    FirestoreClient.prototype.addSnapshotsInSyncListener = function (observer) {
        ...
        this.verifyNotTerminated();
        var wrappedObserver = new AsyncObserver(observer);
        this.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () { return tslib.__generator(this, function (_f) {
            return [2 /*return*/, addSnapshotsInSyncListener(this.eventMgr, wrappedObserver)];
        }); }); });
        return function () {
            wrappedObserver.mute();
            _this.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () { return tslib.__generator(this, function (_f) {
...
function parseSetData(userDataReader, methodName, targetDoc, input, hasConverter, options) {
    ...
    if (options.merge) {
        ...
        for (var _i = 0, _f = options.mergeFields; _i < _f.length; _i++) {
